...
public class PlayerMoveForce : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        bool forward = Input.GetKeyDown(KeyCode.D);
        bool back = Input.GetKeyDown(KeyCode.A);
        ...
        if (Input.GetKey(KeyCode.D)) playerDirection += Vector3.forward;
        if (Input.GetKey(KeyCode.A)) playerDirection += Vector3.back;
